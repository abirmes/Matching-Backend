        ...
        <sidebar class="hidden md:flex md:flex-shrink-0">
            <div class="flex flex-col w-64 bg-blue-900 text-white">
                ...
                <div class="flex-1 px-2 py-4 space-y-1">
                    <!-- Add an active class based on the current route -->
                    ...
                    <a href="/dashboard/types" class="flex items-center px-4 py-2 text-sm font-medium rounded-md {{ request()->is('activities-admin*') ? 'bg-pink-600 text-white' : 'text-blue-100 hover:bg-pink-600 hover:text-white' }} transition-all">
                        <svg class="mr-3 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
