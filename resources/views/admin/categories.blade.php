                        ...
                        <div class="mt-4">
                            <form action="{{ route('categories.update', ['id' => $categorie->id]) }}" method="POST" id="updateForm">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name" id="edit_name" value="{{ $categorie->name }}" class="mt-1 focus:ring-pink-500 focus:border-pink-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                </div>

                                <div class="mb-4">
                                    <label for="edit_description" class="block text-sm font-medium text-gray-700">Description</label>
                                    <textarea name="description" id="edit_description" rows="3" class="mt-1 focus:ring-pink-500 focus:border-pink-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ $categorie->description }}</textarea>
                                </div>
