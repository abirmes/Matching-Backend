          ...
          <div class="grid grid-cols-1 gap-4 mb-4">
            <div>
              ...
              <select id="street" name="street" required
                ...
                <option value="" disabled {{ old('street') ? '' : 'selected' }}>Select street address</option>
                @foreach($streets as $code => $name)
    ...
    <form id="createCenterForm" method="POST" action="{{ route('centers.store') }}">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <input id="centerAddress" name="address" type="text" placeholder="Enter street address" required
            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        ...
        <div>
          <label for="centerSpecialty" class="block text-sm font-medium text-gray-700 mb-1">Specialty</label>
          <select id="centerSpecialty" name="specialty" required
            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
